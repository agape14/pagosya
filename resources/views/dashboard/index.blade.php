...
@section('content')
			...
			<div class="container-fluid">
				<div class="form-head d-flex mb-4 mb-md-5 align-items-start">
					...
					<a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#AddCryptoModal" class="btn btn-primary ml-auto">+ Add New Cyrpto</a>
				</div>
                <div class="row">
				...
				<div class="modal fade" id="AddCryptoModal" tabindex="-1" aria-labelledby="AddCryptoModalLabel-1" aria-hidden="true">
					<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
						<h4 class="modal-title" id="AddCryptoModalLabel-1">Add New Crypto</h4>
						<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
						</div>
						<div class="modal-body">
							
							<label class="form-label d-block mb-2">Crypto Name</label>
							<input type="text" class="form-control w-100 mb-3" placeholder="Crypto Name">
							
							<label class="form-label d-block mb-2">Amount</label>
							<input type="text" class="form-control w-100" placeholder="amount">
