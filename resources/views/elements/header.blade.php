                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
									<div class="header-info">
										<span class="text-black">Hola , <strong>{{ session('nombre_usuario') }}</strong></span>
            							<p class="fs-12 mb-0">Tipo: {{ session('perfil_usuario') }}</p>
									</div>
                                    <img src="{{ asset('images/profile/user.png') }}" width="20" alt=""/>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="{!! url('/cuenta'); !!}" class="dropdown-item ai-icon">
                                    ...
                                    <a href="{{ route('cerrarsesion') }}" class="dropdown-item ai-icon">
